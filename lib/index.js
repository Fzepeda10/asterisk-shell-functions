...
function getQueueState(QUEUE) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, exec("/usr/sbin/asterisk -rx'queue show' | egrep \"^" + QUEUE + " has\" -q && echo -n 1 || echo -n 0")];
                case 1:
 ...
 * @returns 1 (true) ||  0 (false).
 */
function getAgentQueueState(AGENT) {
    return __awaiter(this, void 0, void 0, function () {
        var stdout;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, exec("/usr/sbin/asterisk -rx 'queue show' | grep -w \"" + AGENT + "\" | grep -w dynamic -q && echo -n 1 || echo -n 0")];
                case 1:
                    stdout = (_a.sent()).stdout;
                    return [2 /*return*/, stdout];
            }
 ...
 */
function getAgentName(EXT, TYPE) {
    return __awaiter(this, void 0, void 0, function () {
        var stdout;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, exec("/usr/sbin/asterisk -rx 'queue show' | grep dynamic | egrep \"" + TYPE + "/" + EXT + "\" | head -n1 | awk '{print $1}' | tr -d \"\n\"")];
                case 1:
                    stdout = (_a.sent()).stdout;
                    return [2 /*return*/, stdout];
            }
 ...
 * @returns 1 (true) ||  0 (false).
 */
function getExtenQueueState(EXT, TYPE) {
    return __awaiter(this, void 0, void 0, function () {
        var stdout;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, exec("/usr/sbin/asterisk -rx 'queue show' | grep -w \"" + TYPE + "/" + EXT + "\" | grep -w dynamic -q && echo -n 1 || echo -n 0")];
                case 1:
                    stdout = (_a.sent()).stdout;
                    return [2 /*return*/, stdout];
            }
 ...
 * @returns 1 (true) ||  0 (false).
 */
function getExtenPauseState(EXT, TYPE) {
    return __awaiter(this, void 0, void 0, function () {
        var stdout;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, exec("/usr/sbin/asterisk -rx 'queue show' | grep -w \"" + TYPE + "/" + EXT + "\" | grep -w \"paused\" | grep -w dynamic -q && echo -n 1 || echo -n 0")];
                case 1:
                    stdout = (_a.sent()).stdout;
                    return [2 /*return*/, stdout];
            }
 ...
 * @returns 1 (true) ||  0 (false).
 */
function getExtenAgent(AGENT) {
    return __awaiter(this, void 0, void 0, function () {
        var stdout;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, exec("/usr/sbin/asterisk -rx 'queue show' | egrep '" + AGENT + " \\(' | grep 'dynamic' | head -n1 | grep -o '[0-9].*' | awk '{print $1}' | head -n1 | sed -e 's/)//g' | tr -d \"\n\"")];
                case 1:
                    stdout = (_a.sent()).stdout;
                    return [2 /*return*/, stdout];
            }
 ...
 */
function callFileCreate(NUM, CID, RETRIES, REC_MODE, AUDIO, PREFIX) {
    var call = fs_1.createWriteStream("/var/spool/asterisk/outgoing/" + NUM + ".call");
